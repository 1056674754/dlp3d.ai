...
export default function Footer() {
  const getIcon = (className: string) => {
    if (className === 'xiaohongshu') {
      return (
        <img
          src={resolvePublicUrl('/img/xiaohongshu.svg')}
          width="18"
          height="18"
          alt="小红书"
        />
    ...
    const iconKey = className as keyof typeof SocialIcons
    return SocialIcons[iconKey] || null
  }
